...
const Footer = () => {
  return (
    <footer className="bg-[#141414] rounded-lgd shadow w-screen ">
      <div className="w-screen max-w-screen-xl mx-auto p-4 md:py-8">
        ...
        <span className="block text-sm text-gray-500 text-center dark:text-gray-400">
          Crafted By <a href="https://www.linkedin.com/in/viraj-singh-18b1a4201/" rel='noreferrer' target='_blank' className="text-white hover:underline"> Viraj Singh</a>
        </span>
      </div>
    </footer>
  )
